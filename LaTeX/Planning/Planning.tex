...
\item 2.948g Hydrated Copper Sulfate ${_(s)}$.
...
To make the desired concentration of copper sulfate I will use the equatons:
...
For my project I will need to produce a range of standard solutions for sulfuric acid to use for my reactions in order to determine the rate and order of the reactions.
...
\item Record the volume of hydrogen produced in cm$^3$ every 30 seconds for 5 minutes from the gas syringe markings to the nearest 0.5 decimal place.
\item Repeat the experiment but include 10cm$^3$ of copper sulfate when making up the standard solutions of sulfuric acid.
\end{enumerate} 
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{./Planning/Images/InvertedBurette.jpg}
