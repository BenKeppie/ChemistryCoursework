\chapter {Analysis and Interpretation} %CHANGE UNITS FOR PROGRESS GRAPH AND ADD UNIT HEADER FOR RATE vs CONC GRAPH NOT PROGRESS GRAPH!
%What can you conclude about mechanisms from the rate
%Suggest mechanism with and without catalyst
%Reason for cu2+ being the most effective
%Describe volume vs time graphs with collision theory 
...
\section{Investigating the Solubility of Hydrogen} %EXPLAIN MORE, show calculation of volume of hydrogen expected from 0.1 g of zinc
